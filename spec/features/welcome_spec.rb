...
describe "The Home Page" do
  ...
  it "has a link to a page called quizzes" do
...
describe 'A page called JavaScript' do
  ...
  describe "a page called quizzes" do
    ...
    it "have an input field and a button labeled 'calc'" do
      button = page.find('button')
      expect(button.label).to eq('calc')
    end
...
# xThere should be a link on the home page called "quizzes"
# xWhen a user clicks on "quizzes" they should be re-directed to "/quizzes"
